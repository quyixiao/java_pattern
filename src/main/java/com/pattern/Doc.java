...
public class Doc {
    ...
    // MicGoldWithClass
    // QuickUML
    // 如何同时提高一个软件系统的可维护性，和可复用性，在面向对象程序设计需要解决的问题。
    // 在目前的软件界，学习和应用设计模式正在形成风气，的确，通过学习和应用设计模式，可以更加深入的理解面向对象的设计理念，
    // 从而帮助设计师改善自己的系统，但是设计模式并不能够提供具有普遍性的设计指导原则，但是，在读者经过一段时间的学习和使用以后，
    // 就会觉得这些孤立的设计模式的背后应当还一更加深层的，更具有普遍性的，共同的设计思想
    // 在本书后面的章节中讨论这些 OO 设计原则是提高软件系统的可维护性，可复用性的指导性原则，在有现成的设计模式的地方，设计模式，
    // 就是这些设计原则的具体问题的体现，在没有现成的设计模式的地方，这些设计的原则也是一样的适用，同样的可以对系统设计发挥
    // 指导作用，并对新模式的研究提供向导
    //
